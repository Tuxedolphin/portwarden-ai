...
export async function GET(event) {
  ...
  const t = (url.searchParams.get('tags') || '').split(',').map((x) => x.trim()).filter(Boolean);
  ...
  const mockArchivedIncidents = [
    {
      ...
      tags: [{ id: 1, name: 'critical' }, { id: 2, name: 'equipment' }]
    },
    {
      id: 2,
      incidentId: 'INC-002',
      title: 'Communication Tower Outage',
      summary: 'Primary communication tower experienced power failure affecting vessel coordination',
      archived_at: '2024-01-10T14:45:00.000Z',
      tags: [{ id: 3, name: 'communication' }, { id: 4, name: 'infrastructure' }]
    },
    {
      id: 3,
      incidentId: 'INC-003',
      ...
      tags: [{ id: 5, name: 'training' }, { id: 6, name: 'safety' }]
    }
  ];
