	...
	<div class="incidents-grid">
			...
			<article class="incident-card">
				...
				<footer class="incident-footer">
					...
					<div class="incident-actions">
						...
						<button class="archive-btn" on:click={() => archive(incident.id)}> Archive </button>
					</div>
				</footer>
			</article>
		{/each}
		...
		{#if items.length === 0}
			<div class="empty-state">
				...
				<button class="empty-cta" on:click={() => (showCreate = true)}> Create Incident </button>
			</div>
		{/if}
	</div>
			...
			<div class="ai-modal-content">
				...
				<div class="ai-actions">
					...
					<button
						...
						on:click={() => requestGpt5('escalation')}
					>
