...
const MAPPINGS = {
  ...
  500: {
    ...
    steps: ['Retry the operation.', 'If this keeps happening, capture the details and contact support.']
  }
};
...
export function translateError(err) {
  ...
  const rawMessage = (err && err.message) || (payload && (payload.error || payload.message)) || String(err);
