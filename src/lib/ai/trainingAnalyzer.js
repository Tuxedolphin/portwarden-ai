...
function extractEscalationTriggers(cases) {
	return ['Resolution time > 2 hours', 'Multiple system impact', 'Customer-facing service down'];
}
...
function extractUrgencyPatterns(cases) {
	return ['Critical severity incidents', 'Port operations disruption', 'Revenue impact scenarios'];
}
